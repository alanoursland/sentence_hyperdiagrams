...
suffix heuristics, then writes ontology/reed_kellogg_01_pos.yaml.
"""
...
OUTPUT_PATH = Path("ontology/reed_kellogg_01_pos.yaml")
...
def write_yaml(
    ...
    lines: list[str] = [
        ...
        "#",
        "# Generated by src/build_pos_vocab.py",
